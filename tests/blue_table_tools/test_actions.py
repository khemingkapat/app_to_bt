...
def test_manual_edit_field_existing_assignment():
    ...
    updated_bt_data, updated_assigned = manual_edit_field(
        bt_key, bt_label, edited_val, bt_data, assigned
    )
